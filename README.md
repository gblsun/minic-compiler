...
o resultado gravado em `tests/expected/` — ver [tests/README.md](tests/README.md) para o papel de cada um:
...
[docs/gramatica.md](docs/gramatica.md) e constrói a AST de [docs/ast.md](docs/ast.md).
